        ...
        <div id="wrapper">
            <div id="content-wrapper"> 
                <div class="container-fluid"> 
                    ...
                    <!--Table-->
                    <div class="container">
                        <h2 style="margin-top:0px">Hospital</h2>
                        <div class="row" style="margin-bottom: 10px">
                            <div class="col-md-4">
                                <?php echo anchor(site_url('admin/hospital/create'),'Add', 'class="btn btn-danger"'); ?>
                            </div>
                        </div>
                        ...
                        <table class="table table-bordered" style="margin-bottom: 10px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $hospital->address ?>&nbsp
                                    <?php echo $hospital->postalCode ?>&nbsp
                                    <?php echo $hospital->city ?>
                                </td>
                                <td><?php echo $hospital->hPhoneNum ?></td>
                                <td style="text-align:center" width="200px">
                                    <?php 
                                        echo anchor(site_url('admin/hospital/update/'.$hospital->hId),'Update'); 
                                        echo ' | '; 
                                        echo anchor(site_url('admin/hospital/delete/'.$hospital->hId),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                                    ?>
                                </td>
		                    </tr>
                            <?php
