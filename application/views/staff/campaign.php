   ...
   <?php include APPPATH.'views/staff/includes/header.php';?>
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <!-- Page Features -->  
        <h2 style="margin-top:0px">Blood Campaign</h2>
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('staff/Campaign/create'),'Create', 'class="btn btn-danger"'); ?>
            </div>
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('staff/campaign'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('staff/campaign'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('staff/Campaign/read/'.$campaign->id),'View'); 
				echo ' | '; 
				echo anchor(site_url('staff/Campaign/update/'.$campaign->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('staff/Campaign/delete/'.$campaign->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
