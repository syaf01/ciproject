    ...
    <h2 style="margin-top:0px">List of Donation History</h2>
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('staff/history'); ?>" class="form-inline" method="get">
                </form>
            </div>
        </div>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('staff/History/update/'.$history->tblusers_id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('staff/History/delete/'.$history->tblusers_id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
