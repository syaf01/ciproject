...
class Blooddrive extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'admin/blooddrive' . urlencode($q);
            $config['first_url'] = base_url() . 'admin/blooddrive' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'admin/blooddrive';
            $config['first_url'] = base_url() . 'admin/blooddrive';
        }
        ...
        $this->load->view('admin/blooddrive', $data);
    }
    ...
    public function create() 
    {
        ...
        $this->load->view('admin/blooddrive_form', $data);
    }
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('admin/blooddrive'));
        }
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('admin/blooddrive/update_action'),
